package sypztep.arctechz.common.entity.mob;
...
import sypztep.arctechz.common.entity.mob.goal.RavenDeliverBundleGoal;
import sypztep.arctechz.common.entity.mob.goal.RavenFollowOwnerGoal;
import sypztep.arctechz.common.init.ModEntityTypes;
import sypztep.arctechz.common.init.ModParticles;
import sypztep.arctechz.common.init.ModSoundEvents;
...
public class RavenEntity extends TameableEntity implements GeoAnimatable {
    ...
    protected void initDataTracker(DataTracker.Builder builder) {
        ...
        if (this.random.nextInt(11) == 0) {
            builder.add(TYPE, Type.ALBINO.toString());
        } else {
    ...
    protected void mobTick() {
        ...
        if (!stack.isEmpty() && stack.get(DataComponentTypes.CUSTOM_NAME) != null) {
            ...
            for (int i = 0; i <= count; i++) {
                ...
                getWorld().addParticle(
                        switch (this.getRavenType()) {
                            case DARK, THREE_EYED -> ModParticles.RAVEN_FEATHER;
                            case ALBINO -> ModParticles.RAVEN_FEATHER_ALBINO;
                            case SEA_GREEN -> ModParticles.RAVEN_FEATHER_GREEN;
                        },
    ...
    public ActionResult interactMob(PlayerEntity player, Hand hand) {
        ...
        if (stack.getItem().equals(Items.BUNDLE) && stack.get(DataComponentTypes.CUSTOM_NAME) != null) {
            if (!this.getWorld().isClient) {
                ...
                if (!stack2.isEmpty() && stack2.get(DataComponentTypes.CUSTOM_NAME) != null) {
